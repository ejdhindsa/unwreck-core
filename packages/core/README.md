...
All distribution artifacts are exported under subpaths:
...
All contrast invariants, perceptual bounds, and entrypoint types are verified automatically before every build and publish via Vitest and publint.
